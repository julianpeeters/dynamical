...
object Mealy:
  ...
  def apply[S, A, B, Y](
    ...
    r: S => A => B,
    u: (S, A) => S
  ): Mealy[Mono.Store[S, _] ~> Mono.Interface[A, A => B, _]] =
    PolyMap[Mono.Store[S, _], Mono.Interface[A, A => B, _], Y](r, u).asMealy(i)
  ...
  def apply[S, A1, B1, A2, B2, Y](
    ...
    using Runner2[Mono.Store[S, _] ~> Bi.Interface[A1, A1 => B1, A2, A2 => B2, _], S, A1, B1, A2, B2]
  ): Mealy[Mono.Store[S, _] ~> Bi.Interface[A1, A1 => B1, A2, A2 => B2, _]] =
    PolyMap[Mono.Store[S, _], Bi.Interface[A1, A1 => B1, A2, A2 => B2, _], Y]((r1, r2), (u1, u2)).asMealy(i)
