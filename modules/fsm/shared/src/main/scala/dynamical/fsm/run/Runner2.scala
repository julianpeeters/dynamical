...
import dynamical.fsm.types.{Unify2}
...
object Runner2:
  ...
  given optionRunner2a[S, A, B]: Runner2[
    PolyMap[Store[S, _], Binomial[Some[A], Some[A] => Some[B], None.type, None.type => None.type, _], _],
    ...
    new Runner2[
      ...
      extension [Y] (p: PolyMap[Store[S, _], Binomial[Some[A], Some[A] => Some[B], None.type, None.type => None.type, _], Y])
  ...
  given optionRunner2b[S, A, B]: Runner2[
    PolyMap[Store[S, _], Binomial[None.type, None.type => None.type, Some[A], Some[A] => Some[B], _], _],
    S, None.type, None.type, Some[A], Some[B]] =
    new Runner2[
      PolyMap[Store[S, _], Binomial[None.type, None.type => None.type, Some[A], Some[A] => Some[B], _], _],
      S, None.type, None.type, Some[A], Some[B]]:
      extension [Y] (p: PolyMap[Store[S, _], Binomial[None.type, None.type => None.type,Some[A], Some[A] => Some[B], _], Y])
  ...
  given optionRunner2c[S, A, B]: Runner2[
    PolyMap[Store[S, _], Binomial[Some[A], Some[A] => None.type, None.type, None.type => Some[B], _], _],
    ...
    new Runner2[
      ...
      extension [Y] (p: PolyMap[Store[S, _], Binomial[Some[A], Some[A] => None.type, None.type, None.type => Some[B], _], Y])
  ...
  given optionRunner2d[S, A, B]: Runner2[
    PolyMap[Store[S, _], Binomial[None.type, None.type => Some[B], Some[A], Some[A] => None.type, _], _],
    ...
    new Runner2[
      ...
      extension [Y] (p: PolyMap[Store[S, _], Binomial[None.type, None.type => Some[B], Some[A], Some[A] => None.type, _], Y])
  ...
  //   ]:
  //     def run[Y](
  //       p: PolyMap[Store[S, _], Binomial[Some[A], Some[A] => None.type, None.type, None.type => Some[B], _], Y]
  ...
  given optionRunner2x[S1, S2, A, B]: Runner2[
    (Store[S1, _] ⊗ Store[S2, _]) ~>
      (Binomial[Some[A], None.type, None.type, Some[String], _] ⊗ Binomial[None.type, None.type, Some[String], Some[B], _]) ~>
        (Binomial[Some[A], Some[A] => None.type, None.type, None.type => Some[B], _]),
    (S1, S2),
    Some[A],
    None.type,
    None.type,
    ...
    new Runner2[
      ...
      extension [Y] (p: ((Store[S1, _] ⊗ Store[S2, _]) ~>
        (Binomial[Some[A], None.type, None.type, Some[String], _] ⊗ Binomial[None.type, None.type, Some[String], Some[B], _]) ~>
          (Binomial[Some[A], Some[A] => None.type, None.type, None.type => Some[B], _]))[Y]
      )
